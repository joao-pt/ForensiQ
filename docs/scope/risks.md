...
| Campo | Valor |
|---|---|
| Versão | 1.3 · 24 jun 2026 (Markdown) |
...
| **R02** | Dificuldade em aprender Django/DRF no tempo disponível | Média | Alto | Código com revisão obrigatória; começar pelo modelo de dados (ponto forte) | 🟢 ≈967 testes na suite `core/` + 38 E2E |
...
| **R06** | Demo interna síncrona não realizada na janela prevista (Sem 7) | Média | Médio | Demo assíncrona via produção `forensiq.pt`; documentar no Cap 3.4 do intercalar; oferecer demo síncrona em Sem 9-10 | 🟢 Demo assíncrona via produção aceite; Relatório Intercalar aprovado (6 mai). Encerrado |
| **R07** | Concentração de *commits* na recta final percepcionada como fragilidade | Média | Médio | Congelar repositório nos últimos 7 dias antes da entrega final; só *fixes*. Histórico já mostra cadência regular Sem 1-7 | 🟢 **Materializou-se, mitigado e encerrado**: a Fase 2/3 concentrou actividade em Jun (177 *commits* nos últimos 7 dias; 443 no total). Mitigado por cadência regular ao longo de todo o semestre, *branches*/PRs e mensagens Conventional Commits descritivas que evidenciam trabalho contínuo. Congelamento concluído; entrega final submetida a 24 jun 2026 |
...
| 24 jun 2026 | R02, R06, R07 | Encerramento: E2E=38; congelamento concluído e entrega final submetida; R06 encerrado (demo/intercalar resolvidos) | Reconciliação de encerramento (Sem. 17) |
