...
def test_type_specific_fields_toggle_by_type(page, auth_as, live_server):
    ...
    assert page.is_disabled("#f-tsd-MOBILE_DEVICE-imei") is False
    assert page.is_visible("#f-tsd-MOBILE_DEVICE-imei")
    assert page.is_disabled("#f-tsd-VEHICLE-vin") is True
