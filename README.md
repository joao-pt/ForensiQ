...
- **i18n no frontend + 2.º idioma** — sobre a base `gettext`/pt-PT já implementada (mensagens de bibliotecas localizadas), acrescentar catálogo de interface no frontend e en-US selecionável
